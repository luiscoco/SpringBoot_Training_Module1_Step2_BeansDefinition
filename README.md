# SpringBoot_Training_Module1_Step2_BeansDefinition
...
In Spring, DI is facilitated by the **Inversion of Control (IoC) container**, which manages the lifecycle and configuration of application components (**beans**).

This promotes loose coupling and easier testing.

### Why Do We Need It in Flight Application?

In the current Flight Application, object dependencies are manually managed, leading to tightly coupled code and difficulties in testing and maintenance. 

By using Spring's DI, we can decouple components, making the application more modular, testable, and easier to manage.
...
Consider using constructor injection for mandatory dependencies and setter injection for optional ones. 

Avoid field injection to keep code testable and maintainable.
